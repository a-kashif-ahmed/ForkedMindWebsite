    ...
    return (
        <>
            <div className="bg-white dark:bg-black transition-colors duration-500">
                <p>he</p>
                <section className="font-[Passero_One] pt-28 pb-20 px-6 text-center max-w-xl mx-auto my-slide">
                ...
                <section className="font-[Passero_One] py-12 px-6 text-center max-w-xl mx-auto">
                    ...
                    <img
                        ...
                        className="mt-3 w-full h-auto rounded-lg dark:hidden"
                    />

                    <img
                        src={dashboarddark}
                        alt="Dashboard preview"
                        className="mt-3 w-full h-auto rounded-lg hidden dark:block"
                    />
                    ...
                    <section className="flex flex-col md:flex-row items-center gap-6 px-6 py-12 md:py-16 max-w-6xl mx-auto">
                        ...
                        <div className="flex-1 relative">
                            ...
                            <img
                                src={ksmile}
                                alt=""
                                className="absolute -top-17 right-4 w-20 an"
                            />
